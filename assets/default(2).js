        ...
        $(this).ajaxSubmit({
            ...
            success: function (response, status, xhr, $form) {
                ...
                if (response.success) {
                    ...
                    if($form.attr('id') == 'office-auth-register'){
						    
						  //  yaCounter47680987.reachGoal('registration');
						    
						}else {
						  //  yaCounter47680987.reachGoal('login');
						}
                    
                        hidePopup('popup_signin');
						 hidePopup('popup_signup');
						 $('#popup_message2').find('h3').text('Спасибо за регистрацию');
						 $('#popup_message2').find('p').text(response.message);
						 showPopup('popup_message2');
